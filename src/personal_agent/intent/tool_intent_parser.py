...
【单工具示例】"""
    ...
    def _pre_filter_tools(self, user_input: str) -> Optional[List[AgentTool]]:
        ...
        keyword_mapping = {
            ...
            "generate_image": ["图片", "照片", "画", "绘画", "图像", "生成图片", "生成照片", "画图", "AI绘画", "AI画"],
            "save_document": ["保存", "生成文档", "生成pdf", "保存成pdf", "保存为pdf", "生成word", "生成doc", "保存成doc", "保存为doc", "生成excel", "保存成excel", "保存为excel", "存成", "存为", "文档", "pdf", "word", "doc", "excel", "xlsx", "表格", "信息表", "数据表", "报表", "通讯录", "名单", "清单", "列表"],
